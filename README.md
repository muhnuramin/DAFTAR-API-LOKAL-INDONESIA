...
| Hadith API          | [Khairil Rahman](https://github.com/kyyril)     | [Link](https://github.com/kyyril/hadith-api)                          | ✅     | Hadith API menyajikan hadis terjemahan dari 9 perawi. Mendukung pencarian berdasarkan perawi, nomor hadis, serta fitur pagination dan search.                    | `false`     |
...
| Waktu Sholat API    | [Maftuh Ichsan](https://github.com/maftuh23)    | [Link](https://github.com/maftuh23/waktu-sholat)                      | ✅     | API Waktu Sholat Indonesia, bersumber dari Kemenag RI, menyajikan data berdasarkan koordinat (latitude & longitude), lengkap dengan informasi provinsi dan kota. | `false`     |
...
| API Harga Emas/Logam Mulia | [cacing69](https://github.com/cacing69)   | [Link](https://github.com/cacing69/logam-mulia-api/blob/main/README.md)       | ✅     | API untuk mengecek harga emas/logam mulia dari berbagai website yang menampilkan info harga beli/jual.                                                                                                                 | `false`         |
...
| PLN (Unofficial)            | [decryptable](https://github.com/decryptable) | [Link](https://pln.decryptable.dev)                                                                     | ✅     | Unofficial API PLN Mobile                                                                                                                                                                                          | `x-api-key` |
